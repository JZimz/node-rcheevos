...
describe('rhash', () => {
  ...
  describe('file mode', () => {
    test('should hash arcade ROM by filename only (dkong.zip)', () => {
      // Arcade hashing ignores file contents — only the zip filename matters
      const result = rhash(27, '/fake/dkong.zip');
      assert.strictEqual(result, '02bbe063efc4b8883206c66e6cb775c9');
    });
